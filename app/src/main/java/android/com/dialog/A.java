package android.com.dialog;

import android.annotation.TargetApi;
import android.com.dialog.kotlinFragment.HomeFragmentK;
...
// https://github.com/Gnzlt/NavigationView-Demo
    ...
    private void selectDrawerItem(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.drawer_home:
                fragmentClass = HomeFragmentK.class;
                break;
